...
import { bodyTypes } from "../../../../api/carOptions";
import { Check, ChevronDown, ListOrdered } from "lucide-react";


export default function BodyType({value, onChange}: FilterSelectProps){
    const [isOpen, setIsOpen] = useState(false);
    const currentOption = bodyTypes.find((opt) => opt.id === value)?.label || "All";
