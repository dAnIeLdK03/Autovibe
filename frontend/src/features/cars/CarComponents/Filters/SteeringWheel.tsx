...
import { wheelTypes } from "../../../../api/carOptions"; 



export default function SteeringWheel({ value, onChange }: FilterSelectProps) {
    const [isOpen, setIsOpen] = useState(false);
    const currentOption = wheelTypes.find((opt) => opt.id === value)?.label || "Steering Wheel";
    return (
