...
import type { DeletedCarCardProps } from "../../../../api/carsService";
import { getImageUrl } from "../../../../utils/getImageUrl";


const DeletedCarCard: React.FC<DeletedCarCardProps> = ({ deletedCar, onDeleteClick, showDeletebutton }) => {
      ...
      >
        {deletedCar.imageUrls && deletedCar.imageUrls.length > 0 ? (
          <img
            ...
            src={getImageUrl(deletedCar.imageUrls[0])}
            alt={`${deletedCar.make} ${deletedCar.model}`}
      ...
      <div className="p-6 flex flex-col flex-grow">
        <div className="flex justify-between items-start mb-4">
          <div>
            ...
            <p className="text-slate-400 font-medium">{deletedCar.model}</p>
          </div>
          <div className="text-right">
            <p className="text-[#70FFE2] text-2xl font-black">
              €{deletedCar.price.toLocaleString()}
            </p>
        ...
        <p className="text-slate-400 text-sm leading-relaxed mb-6 line-clamp-2">
          {deletedCar.shortDescription || "No description available for this premium vehicle."}
        </p>
