              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <button
                    ...
                    className={`text-[10px] uppercase tracking-widest font-black px-3 py-1 rounded-full transition-all active:scale-95 hover:brightness-110 border ${user.role === UserRole.Admin
